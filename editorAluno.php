...
<h5>Preencha todos os campos</h5></br>
 <form name="alterar" action="edtAluno.php" method="POST">
  <input type="hidden" name="id" value="<?php echo $row_post['id']; ?>">
    <div class="form-group">
      <label for="nome"><b>Nome:</b></label>
      <input name="nome" type="text" class="form-control" rows="1" value="<?php echo $row_post['nome']; ?>">
    </div>
    <div class="form-group">
      <label for="gub"><b>Gub:</b></label>
      <input name="gub" type="text" class="form-control" rows="1" value="<?php echo $row_post['gub']; ?>">
    </div>
    </br>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input name="username" type="text" class="form-control" rows="1" value="<?php echo $row_post['username']; ?>">
    </div>
    <div class="form-group">
      <label for="password"><b>Senha:</b></label>
      <input name="password" type="text" class="form-control" rows="1" value="<?php echo $row_post['password']; ?>">
    </div>
  </br>
