...
<div class="container" style="padding: 25">
 <ul class="collection with-header">
        ...
        <a class="btn" href="criaPublicacao.php" style="color: #fff; background-color: #ec1414;"><b>Nova Publicação</b></a>
        <li class="collection-header center"><h4><b>Publicações</b></h4></br></li>
        <?php while ($dado = $con -> fetch_array()) {  ?>
        <li class="collection-item">
          <div><?php echo $dado["titulo"];?></div>
          <div class="right" style="padding: 5px">
          <form method='POST' action='excluiPublicacao.php'>
          ...
          <a href="editorPublicacao.php?id=<?php echo $dado['id']; ?>"><i class="material-icons">edit</i></a>
          </div>
          </br></br>
        </li>
        <?php  }  ?>
